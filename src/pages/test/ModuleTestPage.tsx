...
const ModuleTestPage: React.FC = () => {
    ...
    useEffect(() => {
        if (moduleId) {
            fetchModuleTest(moduleId);
        }
    }, [moduleId, fetchModuleTest]);
                ...
                <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-purple-50">
                    <div className="text-center max-w-md">
                        ...
                        <p className="text-gray-600 mb-6">
                            К сожалению, для этого модуля тест не доступен.
                        </p>
                        <button
                            onClick={() => navigate(-1)}
                                ...
                                {!result.passed && (
                                    <button
                                        onClick={() => {
                                            ...
                                            setSelectedAnswers({});
                                            setTimeElapsed(0);
                                            if (moduleId) fetchModuleTest(moduleId);
                                        }}
                    ...
                    >
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            <div>
                                ...
                                {previousResult && (
                                    <div className={`mt-3 inline-flex items-center gap-2 px-4 py-2 rounded-lg font-semibold ${previousResult.passed
